...
export default function Login() {
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center bg-[#f5eee7] px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-sm bg-white rounded-2xl border border-[#ead8c7] p-6 space-y-4 shadow-sm">
        ...
        <button type="submit" disabled={loading}
          className="w-full rounded-lg bg-[#8a6448] py-2.5 font-medium text-white disabled:opacity-50">
